...
class MessagesSearchWidget extends StatefulWidget {
  const MessagesSearchWidget({required this.bloc, super.key});

  final MessagesSearchBloc bloc;

  @override
  State<MessagesSearchWidget> createState() => _MessagesSearchWidgetState();
}

class _MessagesSearchWidgetState extends State<MessagesSearchWidget> {
                  ...
                  child: ListView(
                      ...
                      children: [
                        for (final item in state.items)
                          CheckItem(
                              text:
                                  '${item?.id}: user_category_id: ${item?.user_category_id} text: ${item?.text}',
